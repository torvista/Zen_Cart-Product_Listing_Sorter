...
// MOD Product Listing Sorter release product sorting id when nothing is there
if (isset($_GET['product_listing_sorter_id']) && $_GET['product_listing_sorter_id'] <= 0) {
  unset($_GET['product_listing_sorter_id']);
  unset($product_listing_sorter_id);
}
